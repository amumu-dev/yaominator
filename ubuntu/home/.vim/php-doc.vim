...
let g:pdv_cfg_Copyright = "Copyright (C) 2008 Yahoo! All rights reserved."
let g:pdv_cfg_License = ""

" TOB: let g:pdv_cfg_Type = "mixed"
" TOB: let g:pdv_cfg_Package = ""
" TOB: let g:pdv_cfg_Version = "$id$"
" TOB: let g:pdv_cfg_Author = "Jiqing Yao<jqyao@yahoo-inc.com>"
...
func! PhpDocFunc()
	...
	exe l:txtBOL . g:pdv_cfg_Comment1 . "@brief " . funcname . " " . g:pdv_cfg_EOL
